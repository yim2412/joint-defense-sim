...
class SplashWindow(QWidget):
    ...
    def _build_plan_tab(self) -> QWidget:
        ...
        _PLANS = [
            ...
            # v21.3 합동 작전 시나리오 라이브러리 = 구현 완료(v21.04.01) — 제거.
            #   육해공 통합 캠페인 3종(전면전·대만해협·제한전)을 시나리오 프리셋으로 추가.
            ...
            # 멀티플레이어 대전 = 미채택(2026-07-24 사용자 결정) — 제거. 단일 시뮬 분석
            #   목적에 집중하고 네트워크 동기화 트랙은 밟지 않는다.
        ]
