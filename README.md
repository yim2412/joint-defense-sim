...
> **현재 단계:** 해군 — 이지스 기동전단 통합 방어 + 공군·지상 작전급(연안방공·상륙·도미노) + 한국형 미사일방어 5계층 + 육해공 합동 화력(협조 타격) + 합동작전 통합 보고서(군별 기여도) + 합동작전 사령부(자원 충돌 경고) (v21.03)
...
> **Current stage:** Navy — Aegis task force integrated defense + air-force & ground operational layers + 5-layer Korean missile defense + joint fires (coordinated strike) + joint operations report (per-service contribution) + joint chiefs of staff (resource conflict alerts) (v21.03)
