...
> **현재 단계:** 해군 — 이지스 기동전단 통합 방어 + 공군·지상 작전급(연안방공·상륙·도미노) + 한국형 미사일방어 5계층 (v18.04)
...
> **Current stage:** Navy — Aegis task force integrated defense + air-force & ground operational layers + 5-layer Korean missile defense (v18.04)
