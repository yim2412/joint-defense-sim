"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   이지스 기동전단 통합 방어 시뮬레이터  v7.23 — PyQt6 런처                 ║
╠══════════════════════════════════════════════════════════════════════════════╣
...
class SplashWindow(QWidget):
    ...
    def _build_plan_tab(self) -> QWidget:
        ...
        _PLANS = [
            ("v7.x", "중간", "아군 잠수함 추가",
             "KSS-I 장보고급(209형, 1,200톤), KSS-II 류관순급(214형 AIP, 1,800톤), "
             "KSS-III 도산안창호급(3,000톤, VLS 6셀) 추가. "
             "아군 잠수함 공격 로직 엔진에 신규 구현 — 현재는 아군 잠수함 개념이 없음. "
             "대잠전단 프리셋 (KDX-III + FFX × 2 + KSS-II × 2) 제공."),
            ("v7.x", "중간", "피해 연동 시스템 세분화",
            ...
            ("v7.x", "중간", "대방사 미사일(ARM) 추가",
             ...
             "피해 연동 시스템과 연계 — 레이더 피탄 시 탐지거리 즉시 저하."),
            ("v7.x", "높음", "레이더 다중 모드 구분",
             ...
             "ARM과 연계 — 레이더 ON/OFF 전술이 실질적 의미를 가짐."),
            ("v7.x", "중간", "실행 기록 DB 저장",
            ...
            ("v8.x", "높음", "연합 작전 C2 통합",
             "한미 연합 교전 시 지휘통제(C2) 통합 처리. "
             "미 해군 SM-3 탄도탄 전담 / 한국 SM-2 순항미사일 대응으로 임무 분담. "
             "결과 탭에 한국·미국 기여도 분리 표시."),
            ("v8.x", "낮음", "도움말 / 튜토리얼 탭",
