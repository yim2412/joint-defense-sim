"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   이지스 기동전단 통합 방어 시뮬레이터  v10.24 — PyQt6 런처                ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  [v10.24 — exe 표시 텍스트 용어 정리: 함수명 제거, 군사용어로]              ║
║  NEW-A  CLAUDE.md '용어 작성 규칙' — exe 텍스트는 군사용어 OK·코드명 금지   ║
║  UPD-A  _PLANS 48개 항목 함수명·클래스명 전량 제거 → 군사용어·일상어 재작성 ║
║  UPD-B  구현 세부(클래스 구조)는 로드맵_상세 문서로 분리                    ║
║  NEW-B  메모리 feedback_changelog_terms — 세션 넘어 규칙 유지               ║
