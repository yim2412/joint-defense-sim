"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   이지스 기동전단 통합 방어 시뮬레이터  v7.40 — PyQt6 런처                 ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  [v7.40 — 피해 연동 시스템 + 대방사미사일(ARM) 추가]                         ║
║  NEW-A  서브시스템 피해 연동: 레이더/추진/무장 독립 피탄 (35/25/40%)         ║
║  NEW-B  대방사미사일 DB 추가: Kh-31P, AGM-88 HARM (레이더 직격, ECM 무효)   ║
║  NEW-C  무장 피탄 시 해당 무기 비활성화 (disabled_weapons 세트 관리)          ║
║  NEW-D  ARM 피격 시 레이더 factor 0.3배 급감 (탐지 직격 피해)               ║
║                                                                              ║
