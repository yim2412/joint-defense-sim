"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   이지스 기동전단 통합 방어 시뮬레이터  v10.23 — PyQt6 런처                ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  [v10.23 — 감사 체크포인트 정책 수립 (마이너 버전마다)]                     ║
║  NEW-A  CLAUDE.md '감사 정책' — 변경 유형별 감사(코드/수치/회귀) 표 + 0단계 ║
║  NEW-B  _PLANS 상단 '📋 정책' 행 — 감사 체크포인트 상시 표시                ║
║  NEW-C  메모리 feedback_audit_policy — 세션 넘어 규칙 유지                  ║
