"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   이지스 기동전단 통합 방어 시뮬레이터  v10.25 — PyQt6 런처                ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  [v10.25 — changelog 용어 작성법 보강 + 과거 정리 계획 등록]               ║
║  NEW-A  CLAUDE.md: changelog 항목 유형별(추가/수정-수치/수정-버그) 작성법   ║
║  NEW-B  v11.6 계획 등록 — 과거 패치 내역 169개 항목 용어 정리 (내일 작업)   ║
...
class SplashWindow(QWidget):
    ...
    def _build_plan_tab(self) -> QWidget:
        ...
        _PLANS = [
            ...
            ("v11.6", "낮음", "과거 패치 내역 용어 정리",
             "과거 changelog 169개 항목(54개 버전, 주로 v7~v8)에서 함수명·클래스명·변수명 제거 → "
             "군사용어·일상어로 재작성. 군사 약어(CIWS·SEAD 등)는 유지. "
             "초반 버전(v5~v6)은 이미 쉽게 작성돼 있어 대상 아님. 일괄 변환 후 검수·빌드."),
            # ── v12.x — 물리 엔진 고도화 ──────────────────────────────────────
