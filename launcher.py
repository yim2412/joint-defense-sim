...
class SplashWindow(QWidget):
    ...
    def _build_plan_tab(self) -> QWidget:
        ...
        _PLANS = [
            ...
            ("v7.10", "낮음", "적군 DB / 아군 DB 탭 신설",
             "스플래시 화면에 적군 DB, 아군 DB 탭 2개 추가. "
             "적군 43종을 대공·대함·대잠 분류별 색상으로 구분해 표시. "
             "아군 무기 8종과 함정 3종도 별도 탭으로 제원 열람 가능."),
            ("v7.x", "중간", "한국 해군 함정 대규모 추가 + 현실 기반 프리셋",
             "수상함 6종 추가 — PKG 윤영하급(유도탄 고속함), PCC 포항급(초계함), "
             "PKX-B 참수리-II(유도탄 고속정), 독도함·마라도함(강습상륙함), AOE 소양함(보급함). "
             "실제 한국 해군 편성 기반 프리셋 5종 신설: 이지스 기동전단 / 이지스 강화 / "
             "독도함 상륙전단 / 동해 해역방어 / 서해 해역방어. "
             "2단계로 KSS-I/II/III 아군 잠수함 추가 및 대잠전단 프리셋 구성."),
