"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   이지스 기동전단 통합 방어 시뮬레이터  v10.26 — PyQt6 런처                ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  [v10.26 — v11.6 범위 확장: 함수명 제거 + 군사용어 통일]                    ║
║  UPD-A  v11.6 계획 — 함수명 제거(169개) + 전체 667항목 군사용어 통일        ║
║  NEW-A  CLAUDE.md 용어 규칙 — 군사용어 적극 사용(풀어쓰기보다 정확한 용어)  ║
