...
class MainWindow(QMainWindow):
    ...
    _ENEMY_PRESET_TIPS = {
        ...
        '항모 킬 체인':
            'DF-21D (대함 탄도) × 2 + DF-17 (HGV) × 1 + J-20 (스텔스) × 2.\n'
        ...
        '대잠 복합':
            ...
            '대잠 헬기·패트리엇 소나 성능 검증.',
        'BMD 탄도 포화':
            'KN-23·DF-15·DF-21D·DF-17 혼합.\n'
            'QBM(기동)~MRBM~HGV 계층 혼합 — SM-3 채널 연속 소진.\n'
            '탄도 방어 집중 검증. 최고 난이도.',
        '전면전 포화':
            'J-20 × 2 + DF-17 × 1 + 055형 × 1 + DF-21D × 1 + 093형 × 1.\n'
    ...
    def _build_plan_tab(self) -> QWidget:
        ...
        _PLANS = [
            ...
            ("v13.1", "중간", "설정·결과 탭 UI 전면 폴리싱 + 버그 수정",
             "① 결과 탭 — 탭 클릭 시 창이 무한정 커지는 레이아웃 버그 수정 (재현 후 sizePolicy·최소 크기 교정). "
             "② 설정 탭 좌측 패널 잘림 — 콘텐츠가 잘리는 구간 확인 후 최소 너비·스크롤 정책 교정. "
             "③ 설정 탭 전체 — QGroupBox·버튼·체크박스·콤보박스 radius 통일, 여백·색상 정리. "
