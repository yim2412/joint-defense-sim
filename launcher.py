"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   합동 통합방어 시뮬레이터  v15.09.02 — PyQt6 런처                          ║
╠══════════════════════════════════════════════════════════════════════════════╣
    ...
    def _build_plan_tab(self) -> QWidget:
        ...
        _PLANS = [
            ...
            ("📋 정책", "상시", "설정 패널 구조 유지",
             ...
             "묶음 간 경계가 모호해지면 재조정."),
            # ── 차기 메이저 — 지속 전장 엔진 (아키텍처 전환) ──────────────────
            ("차기 메이저", "매우 높음", "지속 전장 엔진 — 완전한 양방향 전장으로 전환",
             "현재는 적이 살보 발사 후 이탈하는 단발 교전이라 '요격 후 종료'에 가깝다. "
             "이를 양측이 작전 목표를 두고 시간에 걸쳐 겨루는 지속 전장으로 전면 전환한다. "
             "승패는 요격률이 아니라 임무 달성(자산 방어·해역 통제·소모전·작전 지속성)으로 판정. "
             "적이 목표를 향해 기동·압박하며, 단계적으로 강화학습 기반 자가 대전(아군·적 AI가 "
             "반복 교전하며 스스로 최적 전술을 학습)까지 확장한다. 작전급(캠페인) 규모도 이 엔진이 흡수."),
