"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   이지스 기동전단 통합 방어 시뮬레이터  v13.06.17 — PyQt6 런처             ║
╠══════════════════════════════════════════════════════════════════════════════╣
    ...
    def _build_plan_tab(self) -> QWidget:
        ...
        _PLANS = [
            ...
            ("v13.2", "낮음", "UI 디자인 전반 다듬기",
             "체크박스·드롭다운 정리 완료. 버튼·표·탭·스크롤바·입력창·카드 등 나머지 위젯도 "
             "일관된 색감·여백·마우스 강조 효과로 점진적으로 다듬어 통일감 있는 인터페이스 구축. "
             "기능 변경 없이 시각적 완성도만 높이는 작업 — 사용 중 눈에 거슬리는 곳부터 순차 개선."),
            # ── v14.x — 3D 전장 & 실제 지도 ─────────────────────────────────
