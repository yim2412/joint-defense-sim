"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   합동 통합방어 시뮬레이터  v21.04.01 — PyQt6 런처                          ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  [v21.04.01 — 합동 작전(캠페인) 시나리오 라이브러리 3종 (v21.3)]            ║
║  NEW-A  육해공 통합 캠페인 시나리오 3종을 원클릭 프리셋으로 추가 —          ║
║         ①한반도 전면전(72h 전역, 전 도메인 합동작전) ②대만해협 위기(항모    ║
║         전단 고강도 교착) ③독도·이어도 제한전(국지 다도메인). 각 시나리오는 ║
║         각 군 초기 전력·작전 목표·성공 판정을 서술로 담는다.                ║
║         scenarios.SCENARIO_LIBRARY(순수 데이터). ⚠ 공군 편성·전역 길이는    ║
║         UI 위젯이 없어 기본값(한미 연합 공군·72h)으로 고정 — 위젯 있는       ║
║         키(함대·적편대·캠페인 토글·육군 화력)로만 차별화.                    ║
║  [v21.03.01 — 합동작전 사령부(JCS) 자원 충돌 경고 (v21.1)]                  ║
║  · 각 군 독립 배정의 충돌(협조 미비·육군 미참여·화력 중복)을 지휘부가       ║
║    경고로 표면화하는 상시 관찰층(토글 없음, 교전 결과 무변경).              ║
║                                                                              ║
