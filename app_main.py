"""
╔══════════════════════════════════════════════════════════════════════════════╗
║   합동 통합방어 시뮬레이터  v16.11.01 — PyQt6 런처                          ║
╠══════════════════════════════════════════════════════════════════════════════╣
    ...
    def _build_plan_tab(self) -> QWidget:
        ...
        _PLANS = [
            ...
            ("📋 정책", "상시", "설정 패널 구조 유지",
             ...
             "묶음 간 경계가 모호해지면 재조정."),
            # ── 진행 중 메이저 — 지속 전장 엔진 + 자율 학습 AI ─────────────────
            ("진행 중", "매우 높음", "지속 전장 엔진 — 완전한 양방향 전장",
             "적이 살보 발사 후 이탈하는 단발 교전을, 양측이 작전 목표를 두고 시간에 걸쳐 "
             "겨루는 지속 전장으로 전환. 승패는 요격률이 아니라 임무 달성(자산 방어·해역 통제·"
             "소모전·작전 지속성)으로 판정. 완료: 승리조건 4종, 연료·무장 탑재량 한계, 적 "
             "목표지향 기동·손실 임계 철수, 항모 항공단 유한화·재출격, 해상급유 재보급, 작전 "
             "시계열 화면. 결과·판정·비용·편대 추천도 승률·목표 달성 지표로 전환 완료 — 단발 교전 "
             "모델은 빠른 분석·반복용으로 존속한다. 작전급(캠페인) 규모는 v18 캠페인 엔진이 흡수."),
            ("진행 중", "매우 높음", "자율 학습 전술 AI (강화학습 + AI 자가개선 루프)",
             ...
             "지속 전장에 탑재. 적 지휘 AI 동시 학습(self-play)도 교대 공진화까지 구현해 메커니즘 성립. "
             "남은 선택: 자가개선 루프 장기 실전 운영, 더 깊은 전장·행동공간 위 공진화 심화."),
            # ── v15.x — AI & 자율화 ────────────────────────────────────────────
