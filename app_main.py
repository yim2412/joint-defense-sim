...
from app_workers import (CounterfactualWorker, FleetRecommendWorker, ShowcaseCompareWorker, SimWorker, _SimCancelled, _SysDataWorker, _start_sys_data_worker, _stop_sys_data_worker)
# ════════════════════════════════════════════════════════════════════════════
...
# 시나리오 라이브러리 — scenarios.py로 분리(순수 데이터)
